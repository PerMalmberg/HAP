...
{
	public BooleanInput( String name, UUID id, IComponent parent, boolean isVisibleInComponent )
	{
		super( name, id, parent, false, isVisibleInComponent );
	}

	public BooleanInput( String name, UUID id, IComponent parent )
	{
